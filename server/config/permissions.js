...
export const hasPermission = (user, permission) => {
  ...
  // Handle legacy 'admin' as super_admin / hr_admin
...
export const canManageUser = (actor, targetUser) => {
  ...
  // If target is super admin, NO ONE else can modify them
  if (targetUser && (targetUser.role === 'super_admin' || targetUser.role === 'admin')) {
    return false;
  }

  // HR Admin can manage manager & employee
  if (actorRole === 'hr_admin' || actorRole === 'admin') {
